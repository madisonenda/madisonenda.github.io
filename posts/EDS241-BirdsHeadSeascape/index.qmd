...
The *Mahalanobis distance metric* was used to find the smallest mean differences between distributions of covariates across treated and control sites. All 10 covariates were weighted equally, and after multiple iterations considering the trade-offs between dropped MPA sites and achieving covariate balance, the optimal matching model dropped 13 of the 108 MPA sites and 22 of the 53 control sites.
...
- Monsoon direction Sites (Reefs faced north or westerly exposed to northwest monsoon winds, while reefs facing south and easterly are exposed to southeast monsoon winds. Exposure to currents, wind, and precipitation is assumed to be similar in each group.
